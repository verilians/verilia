  ...
  return (
    <div className="relative" ref={dropdownRef}>
      ...
      {isOpen && (
        <div className="absolute right-0 top-full mt-2 w-64 bg-white rounded-lg shadow-lg border border-gray-200 py-2 z-50">
          <div className="px-4 py-3 border-b border-gray-100">
            <p className="text-sm font-medium text-gray-900">Sign in to Verilia</p>
            <p className="text-xs text-gray-500 mt-1">Access your chat history and preferences</p>
            <p className="text-xs text-green-600 mt-2 font-medium">✅ You can use the app without signing in!</p>
          </div>
          ...
          <div className="py-1">
            <button
              ...
              className="w-full flex items-center space-x-3 px-4 py-2 text-left text-sm text-gray-700 hover:bg-gray-50 transition-colors disabled:opacity-50"
            >
