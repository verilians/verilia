...
const ChatHistoryPanel = () => {
  ...
  const LoadingMessage = () => (
    <div className="flex justify-start transition-all duration-300 ease-out">
      <div className="max-w-[85vw] sm:max-w-xs lg:max-w-md px-3 sm:px-4 py-2 sm:py-3 transition-all duration-200 border-b-2 border-gray-200 dark:border-gray-700 text-gray-800 dark:text-gray-200">
        <div className="flex items-start space-x-2">
          ...
          <div className="flex-1 min-w-0">
            ...
            <p className="text-xs mt-1 sm:mt-2 text-gray-500 dark:text-gray-400">
      ...
      <div className="flex-1 overflow-y-auto p-4">
        <div className="flex justify-center items-center h-32">
          <div className="text-center">
            ...
            <p className="text-sm text-gray-500 dark:text-gray-400">Start a conversation to see your chat history here.</p>
          </div>
        </div>
      </div>
    );
